"""Shared fixtures for Contexta test suite."""
...
# ---------------------------------------------------------------------------
# Shared MockRepository (also used by TST-020 ~ TST-024)
# ---------------------------------------------------------------------------
...
def make_ctx_with_repo(mock_repo, tmp_path):
...
@pytest.fixture()
def ctx_with_repo(mock_repo, tmp_path):
    return make_ctx_with_repo(mock_repo, tmp_path)
